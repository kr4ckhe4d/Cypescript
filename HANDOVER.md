...
| 68 language tests | ✅ local + CI | ✅ CI | ✅ local | ❌ never |
...
Counts as of `c52ad21`: **68** language tests (44 positive with output fixtures, 24
...
```bash
bash tests/run_tests.sh          # 68: 44 positive with output fixtures, 24 negative
