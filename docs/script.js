...
function initializePerformanceCharts() {
    ...
    if (multiLanguageCtx) {
        new Chart(multiLanguageCtx, {
            type: 'bar',
            data: {
                labels: ['Simple Loop (100M)', 'Fibonacci (10M)', 'Matrix (300³)', 'Prime Sieve (500K)'],
                datasets: [{
                    label: 'Cypescript (-O2)',
                    data: [17, 63, 6, 13],
            ...
            options: {
                ...
                plugins: {
                    title: {
                        display: true,
                        text: 'Cypescript vs Node.js — Execution Time (lower is better)',
                    ...
                    tooltip: {
                        callbacks: {
                            afterLabel: function(context) {
                                const speedups = [8.3, 3.0, 16.8, 6.6];
                                return 'Cypescript ' + speedups[context.dataIndex] + 'x faster';
                            }
                        }
                    }
                },
    ...
    // Old charts removed - canvas elements no longer exist in HTML
}
